...
class DiseaseLeafPlant extends StatefulWidget {
  const DiseaseLeafPlant({Key? key}) : super(key: key);

  @override
  State<DiseaseLeafPlant> createState() => _DiseaseLeafPlantState();
}

class _DiseaseLeafPlantState extends State<DiseaseLeafPlant> {
  @override
                  ...
                  Container(
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/images/bg_box7.png'),
                        opacity: 50,
                        fit: BoxFit.cover,
                      ),
                    ),
